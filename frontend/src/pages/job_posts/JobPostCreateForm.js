...
function JobPostCreateForm() {
  ...
  const { title, description, location, job_type, salary, application_deadline, experience_level, company_name, company_description, is_active, application_instructions, allows_remote_work, benefits} =
    jobPostData;
        ...
        <Container className={`d-flex flex-column justify-content-center`}>
          <Form.Group controlId="title">
            <div className="d-flex justify-content-center">
              <Form.Label className={styles.FormLabel}> Job Post Title</Form.Label>
            </div>
            <Form.Control
...
<Form.Group controlId="application_deadline">
  <div className="d-flex justify-content-center">
    <Form.Label className={styles.FormLabel}>Application Deadline</Form.Label>
  </div>
  <Form.Control
    className={styles.FormControl}
...
<Form.Group controlId="experience_level">
  <div className="d-flex justify-content-center">
    <Form.Label className={styles.FormLabel}>Experience Level</Form.Label>
  </div>
  <Form.Control
    className={styles.FormControl}
...
<Form.Group controlId="company_description">
  <div className="d-flex justify-content-center">
    <Form.Label className={styles.FormLabel}>Company Description</Form.Label>
  </div>
  <Form.Control
    as="textarea"
    className={styles.FormControl}
...
<Form.Group controlId="is_active">
  ...
  <Form.Check
    ...
    label="Is Active"
    checked={is_active}
    onChange={(e) => setjobPostData({ ...jobPostData, is_active: e.target.checked })}
  />
</Form.Group>
...
<Form.Group controlId="application_instructions">
  <div className="d-flex justify-content-center">
    <Form.Label className={styles.FormLabel}>Application Instructions</Form.Label>
  </div>
  <Form.Control
    as="textarea"
    className={styles.FormControl}
...
<Form.Group controlId="allows_remote_work">
  <div className="d-flex justify-content-center">
    <Form.Label className={styles.FormLabel}>Allows Remote Work</Form.Label>
  </div>
  <Form.Check
    type="checkbox"
    ...
    onChange={(e) => setjobPostData({ ...jobPostData, allows_remote_work: e.target.checked })}
  />
</Form.Group>
